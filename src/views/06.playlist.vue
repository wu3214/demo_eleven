    ...
    <el-tabs v-model="activeIndex">
      <el-tab-pane label="歌曲列表" name="1">
        <table class="el-table playlit-table">
          ...
          <tbody>
            <tr class="el-table__row" v-for="(item,index) in (playlist.tracks)" >
              <td>{{index+1}}</td>
              <td>
                <div class="img-wrap">
...
export default {
  ...
  methods: {
    playMusic(id) {
        console.log(id)
          console.log(1)
          this.$parent.musicUrl = 'https://music.163.com/song/media/outer/url?id='+id
      },
  ...
  computed:{
      duration(){
        return function(time){
          ...
          const minute = parseInt(time1 / 60 )
          const second = Math.ceil(time1 % 60) 
